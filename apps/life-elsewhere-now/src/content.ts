...
const topics: Array<{ topic: Topic; indicatorId: IndicatorId; sensitivity: LifeTemplate['sensitivity']; lines: [string,string,string,string,string]; ages: [AgeBand,AgeBand,AgeBand,AgeBand,AgeBand] }> = [
  { topic:'food', indicatorId:'SH.H2O.BASW.ZS', sensitivity:'normal', ages:['adult','teen','older-adult','adult','adult'], lines:['A breakfast is being packed before the street fully wakes.','Someone is saving the crispiest piece for the last bite.','A kettle clicks off while a familiar recipe is recalled from memory.','Lunch is being divided into containers for a long day.','A handful of rice is measured by habit, not by recipe.'] },
  { topic:'commute', indicatorId:'SP.URB.TOTL.IN.ZS', sensitivity:'normal', ages:['adult','teen','adult','older-adult','adult'], lines:['A bus window turns the neighborhood into a moving strip of color.','A school bag is shifted from one shoulder to the other at a crossing.','Someone times the walk by the songs in a favorite album.','A familiar route is taken slowly enough to notice a new shop sign.','A shortcut through a quiet lane saves two minutes and adds one small adventure.'] },
  { topic:'school', indicatorId:'IT.NET.USER.ZS', sensitivity:'normal', ages:['child','teen','adult','older-adult','teen'], lines:['A pencil margin fills with tiny stars between two lessons.','A study group is arguing kindly about the best way to explain an answer.','Someone is learning a new tool after work, one short lesson at a time.','A community class begins with everyone helping to arrange the chairs.','A notebook page is flipped back to check a careful correction.'] },
  { topic:'work', indicatorId:'IT.NET.USER.ZS', sensitivity:'normal', ages:['adult','adult','adult','older-adult','older-adult'], lines:['A repair is nearly finished after one stubborn screw finally turns.','A shop counter is being prepared for the first customer.','Two coworkers trade the quiet nod that means a problem is solved.','A notebook holds a checklist polished by years of practice.','A clock is watched less than the task itself.'] },
  { topic:'home', indicatorId:'EG.ELC.ACCS.ZS', sensitivity:'normal', ages:['adult','child','older-adult','adult','adult'], lines:['A window is opened to decide whether today feels warm or cool.','A blanket fort has temporarily changed the shape of the room.','A radio fills the kitchen while plants are given water.','The last clean cup is set upside down beside the sink.','A light is left on for someone who will come home late.'] },
  { topic:'health', indicatorId:'SH.H2O.BASW.ZS', sensitivity:'review', ages:['adult','teen','older-adult','adult','older-adult'], lines:['A short walk is being fitted between two ordinary errands.','A water bottle is refilled before an afternoon outside.','Someone stretches carefully while waiting for the kettle.','A reminder is moved to a place where it will actually be seen.','A glass of water is finished before starting the next errand.'] },
  { topic:'leisure', indicatorId:'IT.NET.USER.ZS', sensitivity:'normal', ages:['teen','adult','child','older-adult','adult'], lines:['A favorite chorus is replayed for the third time.','A half-finished puzzle has claimed the best part of the table.','A game invents new rules every few minutes.','A friend is being sent a photograph of an unexpectedly good cloud.','A conversation drifts from weather to memories and back.'] },
  { topic:'income', indicatorId:'EG.ELC.ACCS.ZS', sensitivity:'review', ages:['adult','adult','older-adult','adult','adult'], lines:['A weekly list is being rearranged so the important things fit first.','A small repair is chosen over replacing something that still works.','Someone compares two prices, then checks the unit size once more.','A jar holds change for a plan that is still taking shape.','A coin jar is weighed by the sound it makes when shaken.'] },
  { topic:'urban-rural', indicatorId:'SP.URB.TOTL.IN.ZS', sensitivity:'normal', ages:['adult','teen','older-adult','adult','adult'], lines:['The day begins with traffic noise arriving before the sunlight.','A familiar path passes more trees than storefronts.','Someone recognizes three neighbors during one short errand.','A delivery route moves between dense blocks and open edges.','A rooster and a siren share the same early morning.'] },
  { topic:'migration', indicatorId:'IT.NET.USER.ZS', sensitivity:'review', ages:['adult','teen','older-adult','adult','adult'], lines:['A voice message keeps two time zones connected.','A new route is starting to feel less like a map and more like habit.','An old phrase is explained to someone hearing it for the first time.','Two versions of a recipe meet in the same pan.','A photo on the wall is dusted gently without a word.'] },
  { topic:'climate', indicatorId:'EG.ELC.ACCS.ZS', sensitivity:'review', ages:['adult','teen','older-adult','adult','adult'], lines:['A curtain is closed before the afternoon heat reaches the room.','The sky is checked before deciding how to travel.','A rain barrel is inspected after a dry week.','A fan, a shaded seat, and a glass of water shape the next hour.','A jacket is chosen by what the window shows, not the forecast.'] },
  { topic:'conflict-context', indicatorId:'SH.H2O.BASW.ZS', sensitivity:'high', ages:['adult','adult','older-adult','adult','adult'], lines:['A community noticeboard lists services available this week.','A long-distance call is planned around a changing connection.','A familiar routine is kept because ordinary things still matter.','Neighbors exchange practical information without turning anyone into a statistic.','A generator is checked before evening lights matter.'] },
];
